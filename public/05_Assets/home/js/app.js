$(document).ready(function(){
  ...
  function setMailContent() {
    ...
    let emailInfo = 'mailto:Client Login?subject=Project%20Estimate&body=';
    ...
    // Footer Text
    let emailFooter = '%0D%0A' + 'Sent%20using%20the%20web%20client%20estimator | www.scl-agency.net' + '%0D%0A';
